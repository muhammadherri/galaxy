...
{{-- @section('breadcrumbs')
    ...
    <a href="" class="breadcrumbs__item active">Credit Note List</a>
@endsection --}}
<div class="card">
    <div class="card-header p-1">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="{{ route("admin.credit-note.create") }}">
                    <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus me-50 font-small-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></span>
                     {{ trans('cruds.creditNote.title_singular') }}</a>
            </div>
        </div>
        @endcan
    </div>
                    ...
                    @foreach($cust as $key => $raw)
                        <tr data-entry-id="{{ $raw->id }}">
                            ...
                            <td>
                                ...
                                @endcan
                                @can('permission_edit')
                                    <a class="btn btn-warning btn-sm waves-effect waves-float waves-light" href="{{ route('admin.credit-note.edit', $raw->id) }}">
                                        {{ trans('global.open') }}
                                    </a>
                                @endcan
                            </td>
