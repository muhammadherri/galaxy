            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title ">
                        ...
                        <a href="" class="breadcrumbs__item">{{ trans('cruds.quotation.fields.edit') }}</a>
                    </h6>
                </div>
                <hr>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-25">
                                    ...
                                    {{-- <input type="date" id="datepicker-1" name="effective_date" class="form-control flatpickr-basic flatpickr-input" value="{{ old('effective_date', isset($quotation) ? $quotation->effective_date : '') }}" required> --}}
                                    <input type="date" name="effective_date" class="form-control flatpickr-basic flatpickr-input" value="{{ old('effective_date', isset($quotation) ? $quotation->effective_date : '') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-25">
                                    ...
                                    <table class="table table-striped tableFixHead">
                                        ...
                                        <tbody class="quotation_container">
                                            ...
                                            <tr class="tr_input" data-entry-id="{{ $raw->id }}">
                                                ...
                                                <td width="30%">
                                                    <input type="text" readonly class="form-control search_item_code" placeholder="Type here ..." name="item_code[]" id="searchitem_{{$key+1}}" autocomplete="off" value="{{$raw->ItemMaster->item_code ??''}} - {{$raw->ItemMaster->description ??''}}" required title="{{$raw->ItemMaster->description ??''}}"><span class="help-block search_item_code_empty" style="display: none;" required>No Results Found ...</span>
                                                    ...
                                                    <input type="hidden" class="search_inventory_item_id" id="id_{{$key+1}}" value='{{$raw->id}}' name="lineId[]" autocomplete="off"></td>
                                                <input type="hidden" class="form-control" id="description_{{$key+1}}" name="description_item[]" autocomplete="off">
                                                <td width="15%">
                                                    <select type="text" id="uom_{{$key+1}}" name="po_uom_code[]" class="form-control" required>
                                                        <option value="{{$raw->po_uom_code}}" selected>{{$raw->po_uom_code}}</option>
                                                        @foreach ($uomCon as $as => $uom)
                                                ...
                                                <td width="15%">
                                                    <input type="text" class="form-control unit_price text-end" name="unit_price[]" id="price_{{$key+1}}" autocomplete="off" value="{{$raw->unit_price}}">
                                                </td>
                                                <td width="20%">
                                                    <input type="date" name="start_date[]" class="form-control datepicker text-end" id="start_date_{{$key+1}}" value="{{$raw->start_date}}" autocomplete="off">
                                                </td>
                                                <td width="20%">
                                                    <input type="date" name="end_date[]" class="form-control datepicker text-end" id="end_date_{{$key+1}}" value="{{$raw->end_date}}" autocomplete="off">
                                                </td>
                                                <td width="10px"><button type="button" class="btn btn-ligth btn-sm remove_tr_quotation" disabled>X</button>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
