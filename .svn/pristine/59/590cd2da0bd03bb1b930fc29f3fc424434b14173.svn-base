            ...
            <div class="card-header">
                <div class="card-header mt-1">
                    <h6 class="card-title">
                        ...
                        <a href="{{ route("admin.bom.create") }}" class="breadcrumbs__item">{{ trans('cruds.bom.fields.edit') }} </a>
                    </h6>
                </div>
            </div>
            <hr>
            <form action="{{ route('admin.bom.update',[$bom->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body mt-2">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-5">
                            <input type="date" name="effectivity_date" class="form-control flatpickr-basic flatpickr-input" id="" value="{{$bom->effectivity_date}}" autocomplete="off" required>
                        </div>
                    </div>
