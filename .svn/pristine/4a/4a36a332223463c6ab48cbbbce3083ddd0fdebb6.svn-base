                ...
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-8 ">
                                    <textarea type="text" class="form-control" aria-valuetext="{{$wo->status_change_reason ?? ''}}{{$wo->canceled_reason??''}}" name="status_change_reason"></textarea>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning "  name='action' value="cancel" data-dismiss="modal"><i data-feather='alert-circle'></i>{{ trans('global.add') }}</button>
                </div>
            </div>
        </div>
    </div>
