    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <hr>
                <div class="card-body">
                    <form action="{{ route("admin.missTransaction.store") }}" method="POST" enctype="multipart/form-data" onsubmit="disableButton()">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label></label><br>
                                        <input type="text" class="form-control " value="{{ Carbon\Carbon::parse($request->date)->format('d-M-Y H:i:s') }}" readonly name="transaction_date">
