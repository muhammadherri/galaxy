        ...
        <div class="container">
            <table  style="height:10px;">
                ...
                <tr>
                    ...
                    <td style="width: 30%; text-align:left;">{{$code}}</td>
                    <td><b style="color: red; text-align:right;  background: #FFDF00;"> {{ $planHead->operation_unit }}</b></td>
                </tr>
            </table>
            <table style="width: 98%">
                <tr>
                    ...
                    <td>________</td>
                    <td ></td>
                    <td  style="width: 40%;  border: 1px solid black; vertical-align: top; text-align: left; padding:5px;" rowspan="3"> Keterangan : <br> {{ $planHead->cust_prod->party_name }}</td>
                </tr>
                <tr>
                    <td>
                        Start Date :
            ...
            <table>
                <tr>
                    <td style="text-align:left;"><h6><b>Finish Good Result :  </b><b style="color: red; background: #FFDF00;">Trim Popreel PM &nbsp &nbsp &nbsp {{$planHead->attribute_number_w + 5}} CM</b></h6></td>
                    <td style="text-align:right;"><b style="color: red">TRIM &nbsp &nbsp &nbsp {{$planHead->attribute_number_w}} CM</b></td>
                </tr>
            </table>
            <hr>
            <table class="table-content ">
            ...
            <table>
                <tr>
                    <td style="height: 50px;"><b>Note : </b><br>{{$header->notes}}</td>
                </tr>
            </table>
