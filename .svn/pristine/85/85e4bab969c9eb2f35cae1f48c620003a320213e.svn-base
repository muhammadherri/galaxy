                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-25">
                                    ...
                                    <input type="text" id="fp-default" name="effective_date" class="form-control flatpickr-basic flatpickr-input" value="{{ old('effective_date', isset($quotation) ? $quotation->effective_date : '') }}" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-25">
