...
<div class="card">
    ...
    <hr>
    <div class="card-body">
        <form id="formship" action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="box-body">
                <br>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 {{ $errors->get('category_code') ? 'has-error' : '' }}">
                                    <input autocomplete="off" readonly type="text" id="note" name="note" class="form-control" value="{{ $category->category_code }}" required>
                                </div>

                                <label class="col-sm-1 control-label" for="number">{{ trans('cruds.category.fields.name') }}</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="category_name" value="{{ $category->category_name }}" maxlength="50">
                                </div>

                                <label class="col-sm-1 control-label" for="number">{{ trans('cruds.category.fields.description') }}</label>
                                <div class="col-sm-3">
                                    <input readonly type="text" class="form-control" name="description" value="{{ $category->description }}" maxlength="50">
                                </div>
                            </div>
                        </div>
                        <br>
