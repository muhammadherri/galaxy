            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Role">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $row->id }}">
                        ...
                        <td>
                            @can('item_show')
                            {{-- <a class="badge btn-sm btn-secondary  waves-effect waves-float waves-light" href="{{ route('admin.category.show',$row->id) }}"> --}}
                            ...
                            <a class="badge btn-sm btn-primary waves-effect waves-float waves-light" href="{{ route('admin.category.edit',$row->id) }}">
                                {{ trans('global.edit')}}
                            </a>
                            @endcan
                            @can('item_delete')
