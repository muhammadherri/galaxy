                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-25">
                                    ...
                                    <input type="text" class="form-control supplier_site_id" value="{{$purchaseorder->supplierSite->address1??''}}" placeholder="Type here ..." name="site_name" autocomplete="off" required>
                            ...
                            <div class="col-md-3">
                                <div class="mb-25">
                                    ...
                                    <input type="text" id="datepicker-1_" name="created_at" class="form-control form-control flatpickr-basic flatpickr-input" value=" {{$purchaseorder->created_at->format('d-M-Y H:i:s')}}" required>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="mb-">
                                            ...
                                            <tr class="tr_input">
                                                ...
                                                <td width="10%">
                                                    @if ($raw->po_quantity<=$raw->quantity_receive)
                                                        ...
                                                        @else
                                                        <input type="text" class="form-control purchase_quantity text-end" value="{{$raw->po_quantity}}" name="purchase_quantity[]" id="qty_1" min="0" autocomplete="off" required>
                                                        @endif
                                                </td>
                                                <td width="10%">
                                                    <input type="text" class="form-control purchase_cost text-end" value="{{number_format(($raw->unit_price ?? $raw->base_model_price ),2,',','.')}}" name="purchase_cost[]" id="price_{{$key+1}}" onblur="cal()" autocomplete="off">
                                                </td>
                                                <td width="10%">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class=" col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control purchase_total" value="{{number_format($grand_total+$tax, 2, ',', '.') }} " readonly="" name="purchase_total">
                                </div>
                            </div>
                        </div>
