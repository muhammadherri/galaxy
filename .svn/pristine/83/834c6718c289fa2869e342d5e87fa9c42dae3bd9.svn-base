...
<div class="card">
    <div class="card-header">
        <h6 class="card-title ">
            ...
            <a href="{{ route("admin.physic.index") }}" class="breadcrumbs__item">{{ trans('cruds.physic.fields.adj') }} </a>
        </h6>
                ...
                <fieldset>
                    <div class="input-group">
                        <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin-top: 1%;">
                            <i data-feather='plus'></i> {{ trans('global.create') }}
                        </button>
        ...
        <table id="table_007" class="table datatable-Order w-100">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.physic.fields.location') }}
                    </th>
                    <th>
                    ...
                    <th>
                        {{ trans('cruds.physic.fields.qtycounted') }}
                    </th>
                    <th>
                        {{ trans('cruds.physic.fields.difference') }}
                    </th>
                    <th>
                        {{ trans('cruds.physic.fields.created_at') }}
                    </th>
