...
@section('content')
    <div class="card">
        <div class="card-header">
            <h6 class="card-title">
                <a href="{{ route('admin.currencies.index') }}" class="breadcrumbs__item">Inventory </a>
                <a href="{{ route('admin.currencies.index') }}"
                    class="breadcrumbs__item">{{ trans('cruds.currency.title') }} </a>
            </h6>
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-primary" href="{{ route('admin.currencies.create') }}">
                        ...
                        {{ trans('global.add') }} {{ trans('cruds.currency.title') }}
                    </a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($currencies as $key => $currency)
                            <tr data-entry-id="{{ $currency->id }}">
                                ...
                                <td>
                                    <a
                                        class="badge bg-dark text-white">{{ $currency->currency_status == 1 ? trans('global.active') : trans('global.not_active') }}</a>
                                </td>
