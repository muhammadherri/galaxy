...
@section('content')
@section('breadcrumbs')
<a href="#" class="breadcrumbs__item">{{ trans('cruds.currency.fields.inv') }}</a>
<a href="{{ route("admin.currencies.index") }}" class="breadcrumbs__item"> {{ trans('cruds.currency.item') }}</a>
<a href="" class="breadcrumbs__item"> {{ trans('cruds.currency.fields.show') }}</a>
@endsection
<div class="card">
