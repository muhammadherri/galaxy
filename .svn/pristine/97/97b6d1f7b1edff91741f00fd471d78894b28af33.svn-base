...
<form action="{{ route('admin.credit-note.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" class="form-control" name="ar_id" value="{{$cust->customer_trx_id}}" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
