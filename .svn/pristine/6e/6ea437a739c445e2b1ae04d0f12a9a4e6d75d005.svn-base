        ...
        <div class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaladd" onclick="generateRandomNumber()" href="">
                    ...
                    {{ trans('global.add') }} Miscellaneous
                </a>
            </div>
        </div>
        @endcan
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-1 col-md-10">
                                <input type="text" id="datepicker-1" class="form-control " value="{{date('m/d/Y')}}" required autocomplete="off" name="date">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-1 col-md-10">
                                <input type="text" class="form-control search_ref_aju" name="reference" id='idtrf' value="MI-{{date("yis")}}" autocomplete="off">
                            </div>
                        </div>
