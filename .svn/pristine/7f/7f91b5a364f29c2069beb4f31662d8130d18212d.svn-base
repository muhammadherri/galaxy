...
<div class="row">
    <div class="card">
        <div class="card-header  mt-50">
            <h6 class="card-title">
                <a href="{{ route("admin.credit-memo.index") }}" class="breadcrumbs__item">Accounting </a>
                <a href="{{ route("admin.credit-memo.index") }}" class="breadcrumbs__item">Credit Memo </a>
                <a href="{{ route("admin.credit-memo.index") }}" class="breadcrumbs__item">Create </a>
            </h6>
        </div>
        <div class="card-body">
                            ...
                            <div class="card-body mt-1 centered">
                                ...
                                <div class="row mb-50">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="hidden" name="job_definition_name" class="form-control" id="" value="Credit Memo" autocomplete="off" required>
                                    </div>
                                </div>
                                        ...
                                        <div class="box-body scrollx tableFixHead" style="height: 380px;overflow: scroll;">
                                            <table class="table table-fixed table-borderless" id="tableAP">
                                                ...
                                                <tfoot>
                                                    <tr id="disableAddRow">
                                                        <td colspan="2">
                                                            <button type="button" class="btn btn-light btn-sm add_payable_creditMemo" style="font-size: 12px;"><i data-feather='plus'></i> Add Rows</button>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </tfoot>
                                    ...
                                    <div class="tab-pane fade show " id="nav-ap-det" role="tabpanel" aria-labelledby="nav-ap-det-tab">
                                        <div class="box-body scrollx tableFixHead" style="height: 380px;overflow: scroll;">
                                            <table class="table table-fixed table-borderless" id="table_journal">
                                                ...
                                                <tbody class="journal_creditMemo">

                                                </tbody>
                                                <tfoot>
                                                    <tr class="" id="tr_tax">
                                                        <td width="15%">
                                                            <input type="text" class="form-control search_acc2" value="{{ $tax->tax_account }} {{ $tax->acc->description }}" name="quantity[]" id="accDes3_0" autocomplete="off" required>
                                                            <input type="hidden" name="account_segment[]" class="form-control datepicker" id="acc3_" value="{{ $tax->tax_account }}" autocomplete="off">
                                                            <input type="hidden" class="form-control" value="1" id="line_1" name="line_type_lookup_code[]">
                                                        </td>
                                                        <td width="30%">
                                                            <input type="text" readonly class="form-control" value="{{ $tax->acc->description }}" name="item_description[]" id="des3_" autocomplete="off" required>
                                                        </td>
                                                        <td width="20%">
                                                        ...
                                                        <td width="20%">
                                                            ...
                                                            <input type="hidden" name="total_nrec_tax_amount[]" readonly class="form-control datepicker float-center tax text-end" value="" autocomplete="off">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td width="20%">
                                                            <label id="calculate2" class="form-control calculate2 text-end">0</label>
                                                            <input type="hidden" name="total_rec_tax_amount[]" id="calculate" readonly class="form-control calculate float-center text-end" autocomplete="off">
                                                        </td>
                                                        <td width="20%">
                                                            <input type="hidden" name="total_nrec_tax_amount[]"  readonly class="form-control datepicker float-center text-end" autocomplete="off">
                                                            <label class="form-control text-end">0</label>
                                    ...
                                    <div class="row mt-1 mb-1">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="pajak" name="tax_rate" value="{{$tax->tax_rate}}">
                                                <input type="hidden" class="form-control" id="pajak_code" name="tax_code" value="{{$tax->tax_code}}">
