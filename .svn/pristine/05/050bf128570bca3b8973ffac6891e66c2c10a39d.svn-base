                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-2">
                                ...
                                <input type="text"  class="form-control" readonly value="{{$wo->source_line_ref}}" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-3 col-12">
                            <div class="mb-2">
                        ...
                        <div class="col-md-1 col-12">
                            <div class="mb-2">
                                ...
                                <input type="text"  class="form-control" readonly value="{{(int)$wo->attribute_float1 ?? 0}} GSM" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-1 col-12">
                            <div class="mb-2">
                                <label class="col-sm-0 control-label" for="number">Length</label>
                                <input type="text"  class="form-control" readonly value="{{(int)$wo->attribute_float10 ?? 0}} CM" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-1 col-12">
                            <div class="mb-2">
                                <label class="col-sm-0 control-label" for="number">Width</label>
                                <input type="text"  class="form-control" readonly value="{{(int)$wo->attribute_float2 ?? 0}} CM" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped tableFixHead" id="tab_logic">
                        ...
                        <tbody class="completion_container">
                                @php $jumbo = 0; $jumb_qty=0; @endphp
                                @foreach ($serial as $key => $s)
                                    <tr class="tr_input">
                                        <td width="auto" align="center">{{$key+1}}</td>
                                        <td width="30%">
                                            <input type="hidden" class="line_id" id="line_id_{{$key +1}}" name="line_id[]" value="{{$s->id}}">
                                            <input type="text" class="form-control search_sales" id="item_sales_{{$key+1}}"  value="{{$s->serial_number ?? $s->id}}" name="serial_number[]" autocomplete="off" required>
                                        </td>
                                        <td width="auto">
                                            <input type="text" id="harga_{{$key+1}}" class="form-control harga" name="job_definition_name[]" value="{{$s->job_definition_name ?? $s->uniq_attribute_roll}} "  required>
                                        </td>
                                        <td width="auto">
                                            <input type="number" class="form-control recount text-end" id="jumlah_{{$key+1}}" name="quantity_usage[]" value="{{$s->quantity_usage ?? $wo->planned_start_quantity}}" required>
                                        </td>
                                        <td width="25%">
                                            <div class="col-xs-2">
                                                <input class="form-control text-center" id="gsm_{{$key+1}}" name='attribute_char1[]' type="text" value="{{$s->attribute_char1 ?? $s->attribute_number_gsm}}"   style="width: 30%;">/
                                                <input class="form-control text-center" id="l_{{$key+1}}" name='attribute_char2[]' type="text" value="{{$s->attribute_char2 ?? $s->attribute_number_l}}"  style="width: 30%;">/
                                                <input class="form-control text-center" id="w_{{$key+1}}" name='attribute_char20[]' type="text" value="{{$s->attribute_char20 ?? $s->attribute_number_w}}"  style="width: 30%;">
                                            </div>
                                        </td>
                                    </tr>
                                    @php $jumbo = $key+1; $jumb_qty +=$s->quantity_usage  ??  $wo->planned_start_quantity; @endphp
                                @endforeach
                        </tbody>
                        {{-- <tfoot> --}}
                            <tr>
                                ...
                                <th width="auto">
                                    <input type="number" class="form-control recount text-end"  value="{{$jumb_qty}}" required>
                                </th>
                                <th></th>
                            </tr>
                            <tr>
                                ...
                                <th  class="text-start">
                                    <b>{{$planning[0]->total_roll_by_line -$jumbo}}</b>
                                </th>
                                <th width="auto">
                                    <input type="number" class="form-control recount text-end"  value="{{$wo->planned_start_quantity-$jumb_qty}}" required>
                                </th>
                                <th></th>
                            </tr>
                        {{-- </tfoot> --}}
