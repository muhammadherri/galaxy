                                ...
                                <div class="row mb-25">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="ship_to" name="deliver_to_org_id" class="form-control select2" required>
                                            <option value="BM-000000000" {{old('cust_party_code') ? 'selected' : '' }}>Default</option>
                                            @foreach($site as $row)
                                            @if ($row->site_code!='BM-000000000')
                                            <option value="{{$row->site_code}}" {{old('deliver_to_org_id') == $row->site_code ? 'selected' : '' }}>{{$row->address1}}, {{$row->city}} </option>
                                            @endif
                                    ...
                                    <div class="box-body scrollx" style="height: 300px;overflow: scroll;">
                                        <table class="table table-striped tableFixHead" id="tab_logic">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="9">
                                                        {{-- <button type="button" class="btn btn-ligth add_sales_order " style="font-size: 12px;"><i data-feather='plus'></i> Add Rows</button> --}}
