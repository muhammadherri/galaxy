    ...
    public function index()
    {
      //  abort_if(Gate::denies('order_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
       ...
       //  $purchaseRequisition = PurchaseRequisition::where('authorized_status',2)->get();
		 ...
		 $currency=CurrencyGlobal::select('currency_code')
            ->join('bm_currency_rate_id','bm_currency_rate_id.currency_id','=','bm_currencies_id_all.currency_code')
            ->groupBy('bm_currencies_id_all.currency_code')
            ->get();
         $vendor=Vendor::all();
		 $site=Site::all();
         HPCount::create();
