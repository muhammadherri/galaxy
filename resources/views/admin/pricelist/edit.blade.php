                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-1">
                                            ...
                                            <select name="price_list_name" id="price_list_name" class="form-control select2" required>
                                                <option value="{{$pricelist->price_list_name}}"> {{$pricelist->customer->party_name}}</option>
                                                @foreach($customers as $row)
                                                @if ($pricelist->price_list_name !=$row->id)
                                                <option value="{{$row->customer_party_code}}"> {{$row->party_name}}</option>
                                                @endif
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="description" name="description_header" class="form-control" value="{{ old('description', isset($pricelist) ? $pricelist->description : '') }}" required>
                                    ...
                                    <table class="table table-responsive" id="tab_logic">
                                        ...
                                        <tbody class="pricelist_container">
                                            ...
                                            <tr class="tr_input" data-entry-id="{{ $list_detail->id }}">
                                                ...
                                                <td width="15%">
                                                    <input type="number" class="form-control unit_prices_list text-end" min=1  oninput="validity.valid||(value='');" id="unit_prices_list_{{ $key+1}}" name="unit_prices[]" autocomplete="off" value="{{ $list_detail->unit_price }}">
                                                    <input type="hidden" id="prices_list_{{ $key+1}}" name="prices_list[]">
                                                </td>
                                                <td width="5%">
                                                    <input type="number" class="form-control discount" id="discount_{{ $key+1}}" name="discount[]" min=0  oninput="validity.valid||(value='');" value="{{ $list_detail->discount }}" autocomplete="off">
