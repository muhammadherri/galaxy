                                            ...
                                            <div class="box-body" style="height: 350px;">
                                                <table class="table table-bordered table-striped table-hover  w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            {{-- <td >
                                                                            <input type="checkbox"name="iddelete[]" id="id" value="{{ $row->id }}" class="form-check-input sub_chk" data-id="{{ $row->id }}">
                                                            ...
                                                            <td style="width: 2%">
                                                                ...
                                                                {{-- <button type="submit" class="btn btn-sm btn-danger "name="action" value="delete" id="hapus" >X</button>
                                                                                    <input type="hidden" value="{{$row->id}}" name="deleteId"data-id="{{$row->id}}"> --}}
                                                            </td>
                                                            {{-- <td style="width: 0%">
                                                                                    @if ($DeliveryHeader->lvl == 6)
                                                                                        <button type="button" name='action' value="delete"
                                                                                            class="btn btn-sm btn-danger"
                                                                                            onclick="deleteItem({{ $row->id }})" id="hapus">
                                                            X
                                                            </button>
                                                            @endif
