                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-1">
                                ...
                                <input type="hidden" class="form-control " name="payment_type" value="Outbound" autocomplete="off" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body mt-1">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <label class="control-label" for="rate">Refelsal Date : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <b class="text-end" id="diff"></b>
                            </label>
                            <input type="hidden" readonly class="form-control text-end" name="paid" id="" value="0" autocomplete="off">
                            <div class="form-check mt-1">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" name='action' value="payment" class="btn btn-sm btn-primary check">Create Credit Note</button>
            </div>
        </div>
    </div>
</div>
