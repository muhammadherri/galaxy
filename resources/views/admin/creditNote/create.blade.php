...
<div class="row">
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="{{ route('admin.ar.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <div class="card-body mt-50 centered">
                                <div class="row mb-50">
                                    ...
                                    <div class="col-md-1">
                                        <b>
                                            <p class="text-start">{{ trans('cruds.aReceivable.ar.trx_date') }}
                                            </p>
                                        </b>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" id="datepicker-1" name="trx_date" value="{{date('d-M-Y')}}" class="form-control datepicker" autocomplete="off" required>
                                    </div>
                                    <div class="col-md-1">
                                        <b>
                                ...
                                <div class="row mb-50">
                                    <div class="col-md-1">
                                        <b>
                                            <p class="text-start">{{ trans('cruds.aReceivable.ar.bill_to') }}</p>
                                        </b>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @if ($errors->has('terms'))
                                        <em class="invalid-feedback">{{ $errors->first('terms') }}</em>
                                        @endif
                                    </div>
                                    <div class="col-md-1">
                                        <b>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select name="invoice_currency_code" id="customer_currency" class="form-control select2" required>
                                            ...
                                            <option value="{{ $row->currency_code }}">{{ $row->currency_code }} - {{ $row->currency_name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="datepicker-2" name="gl_date" value="{{date('d-M-Y')}}" class="form-control datepicker" autocomplete="off" required>
                                        ...
                                        <div class="box-body scrollx tableFixHead" style="height: 380px;overflow: scroll;">
                                            <table class="table table-fixed table-borderless">
                                                ...
                                                <tbody class="journal_container">
                                                    <tr class="tr_input">
                                                        ...
                                                        <td width="25%">
                                                            ...
                                                            <input type="hidden" name="frt_ed_amount[]" readonly class="form-control subtotalAdd float-center text-end" id="subtotal_1" value="0" autocomplete="off">
                                                        </td>
                                                        <td width="20%">
                                                            <label class="form-control  text-end">0</label>
                                                            <input type="hidden" name="frt_uned_amount[]" readonly class="form-control float-center text-end" id="price_1" autocomplete="off">
                                                        </td>
                                                        <td>
                                                ...
                                                <tfoot>
                                                    <tr class="">
                                                        <td width="15%">
                                                            <input type="text" class="form-control search_acc2" value="{{ $tax->tax_account }} {{ $tax->acc->description }}" name="quantity2[]" id="accDes3_" autocomplete="off" required>
                                                            ...
                                                            <input type="hidden" name="code_combinations[]" class="form-control datepicker" id="acc3_" value="{{ $tax->tax_account }}" autocomplete="off">
                                                        ...
                                                        <td width="25%">
                                                            <input type="text" readonly class="form-control" value="{{ $tax->acc->description }}" name="description[]" id="des3_" autocomplete="off" required>
                                                        </td>
                                                        <td width="20%">
                                                            <label class="form-control text-end tax">0</label>
                                                            <input type="hidden" name="frt_ed_amount[]" readonly class="form-control tax float-center text-end" value="0" autocomplete="off">
                                                        </td>
                                                        <td width="20%">
                                                            <label class="form-control text-end ">0</label>
                                                            <input type="hidden" name="frt_uned_amount[]" readonly class="form-control datepicker float-center text-end" autocomplete="off">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td width="20%">
                                                            <label class="form-control text-end">0</label>
                                                            <input type="hidden" name="frt_ed_amount[]" readonly class="form-control float-center text-end" autocomplete="off">
                                                        </td>
                                                        <td width="20%">
                                                            <label id="calculate" class="form-control calculate text-end">0</label>
                                                            <input type="hidden" name="frt_uned_amount[]" id="calculate" readonly class="form-control calculate float-center text-end" value="0" autocomplete="off">
...
{{-- <a href="deliveryOrders/${row.delivery_id}"" target=�_blank� class="btn btn-sm btn-secondary"> Print</a> --}}
@endpush
