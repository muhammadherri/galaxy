                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a class="btn btn-primary" href="{{ route("admin.orders.create") }}">
                                ...
                                {{ trans('cruds.purchaseOrder.title_singular') }} </a>
                            @endcan
                        </div>
                    </div>
                        ...
                        <table id="table-purchase" class="table table-bordered table-striped w-100 dataTable no-footer" data-source="data-source">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.purchaseorder.fields.rate_date') }}
                                    </th>
                                    <th>
        ...
        $(document).ready(function() {
            ...
            var table = $('#table-purchase').DataTable({
                ...
                , columnDefs: [{
                    ...
                    , {
                        render: function(data, type, row, index) {
                            content = ` @can('order_show') <a target="_blank" class="badge btn-sm btn-primary" href="orders/${row.po_head_id}">
                            {{ trans('global.view') }}
                        </a> @endcan   @can('order_edit')<a class="badge btn-sm btn-info" href="orders/${row.po_head_id}/edit">
                            {{ trans('global.open') }}
                        </a> @endcan
                        @can('order_delete')<a  class="badge btn-delete btn-accent btn-danger m-btn--pill btn-sm m-btn m-btn--custom" data-index="${row.id}">{{ trans('global.delete') }}</a> @endcan
                       `;
                            return content;
                        }
                        , targets: [9]
