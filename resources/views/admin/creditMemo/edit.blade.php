                                            ...
                                            <table class="table table-fixed table-borderless">
                                                ...
                                                <tbody class="requisition_container">
                                                    ...
                                                    <tr class="tr_input" id="rowTab1_{{ $key+1 }}">
                                                        ...
                                                        <td width="15%">
                                                            <input type="text" name="quantity_invoiced[]" class="form-control recount_ap float-center text-end" value="{{$row->quantity_invoiced}}" id="qty_{{$key+1}}" autocomplete="off">
                                                        </td>
                                                        <td width="10%">
                                            ...
                                            <table class="table table-fixed table-borderless">
                                                ...
                                                <tbody class="journal_container">
                                                    ...
                                                    <tr class="tr_input">
                                                        ...
                                                        <td width="20%">
                                                            <label class="form-control text-end" id="price2_{{ $key+1 }}">{{number_format($row->total_rec_tax_amount)}}</label>
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td width="20%">
                                                            <label class="form-control text-end">{{number_format($row->total_rec_tax_amount)}}</label>
