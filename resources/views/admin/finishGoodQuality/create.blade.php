...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.qm-finsihGood.store') }}" class="" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card">
                    ...
                    <div class="card-body mt-2">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="uniq_attribute_roll" class="form-control" readonly value="{{$roll}}" autocomplete="off" required>
                            </div>
                            ...
                            <div class="col-md-5">
                                <input type="text" id="datepicker-1" name="transaction_date" value="{{date('d-M-Y')}}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="planned_start_quantity" class="form-control" value="{{$serial->item->item_code}} - {{$serial->item->description}}" required>
                                <input type="hidden" name="inventory_item_id" class="form-control" value="{{$serial->inventory_item_id}}" required>
                                <input type="hidden" name="reference" class="form-control" value="{{$serial->serial_number}}" required>
                            </div>
                            <div class="col-md-1">
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="attribute_char" class="form-control datepicker" id="" value="{{$serial->pm->name ?? ""}}" autocomplete="off" required>
