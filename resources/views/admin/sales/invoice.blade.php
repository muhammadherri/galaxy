...
<div class="card">
    <div class="card-header mt-1 mb-1">
        <h6 class="card-title">
            <a href="" class="breadcrumbs__item">{{ trans('cruds.assetMng.field.invoice') }}</a>
            <a href="{{ route("admin.bom.index") }}" class="breadcrumbs__item">  Report </a>
        </h6>
    </div>
    <div class="card-body " >
            ...
            <table id="table-sales" class=" table table-bordered table-striped w-100" >
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.Delivery.fields.acepdet') }}
                        </th>
                        <th>
                        ...
                        <th class="text-center">
                            {{ trans('cruds.OrderManagement.reports.total') }}
                        </th>
                        <th class="text-center">
