...
<form action="<?php echo e(route('admin.credit-memo.store')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" class="form-control" name="invoice_id" i value="<?php echo e($ap->invoice_id); ?>" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
...
<?php /**PATH /var/www/html/resources/views/admin/accountPayable/creditMemo.blade.php ENDPATH**/ ?>