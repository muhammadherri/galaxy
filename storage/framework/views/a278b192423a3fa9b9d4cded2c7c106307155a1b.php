...
<div class="card">
    <div class="card-header">
        <h6 class="card-title">
            ...
            <a href="<?php echo e(route("admin.gl.cash")); ?>" class="breadcrumbs__item"> Journal Cash </a>
        </h6>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/glmanual/cash.blade.php ENDPATH**/ ?>