...
<div class="row">
    <div class="card">
        <div class="card-header  mt-50">
            <h6 class="card-title">
                <a href="<?php echo e(route("admin.credit-memo.index")); ?>" class="breadcrumbs__item">Accounting </a>
                <a href="<?php echo e(route("admin.credit-memo.index")); ?>" class="breadcrumbs__item">Credit Memo </a>
                <a href="<?php echo e(route("admin.credit-memo.index")); ?>" class="breadcrumbs__item">Create </a>
            </h6>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/creditMemo/create.blade.php ENDPATH**/ ?>