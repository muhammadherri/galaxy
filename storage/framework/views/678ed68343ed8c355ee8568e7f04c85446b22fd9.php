...
<section class="modern-horizontal-wizard">
    <form action="<?php echo e(route("admin.item-master.store")); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="mb-25 col-md-4">
                <label class="form-label" for="bomflag"><?php echo e(trans('cruds.itemMaster.fields.minstock')); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/itemMaster/createTabs.blade.php ENDPATH**/ ?>