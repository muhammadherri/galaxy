        ...
        <div class="card-header ">
            <h6 class="card-title">
                <a href="<?php echo e(route('admin.prodplan.index')); ?>"
                    class="breadcrumbs__item"><?php echo e(trans('cruds.planning.manufacture')); ?> </a>
                <a href="<?php echo e(route('admin.prodplan.index')); ?>" class="breadcrumbs__item"><?php echo e(trans('cruds.planning.title')); ?>

                </a>
            </h6>
            <form action="<?php echo e(route('admin.work-order.store')); ?>" method="POST" enctype="multipart/form-data"
                ...
                <div class="d-flex justify-content-center bd-highlight inline">
                    ...
                    <div class="p-50 bd-highlight">
                        <input type="text" id="datepicker" name="planning_date"
                            class="form-control text-center flatpickr-basic" value=" <?php echo e(date('Y-m-d')); ?>" required>
                    </div>
                    <div class="p-25">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#orderData">
                            ...
                            <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.planning.title')); ?>
        ...
        <div class="card-body">
            <table id="planning" class=" table table-bordered table-striped w-100">
                <thead>
                    <tr>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.no')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.plan_date')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.order_num')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.po_num')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.customer')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.item')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.gsm')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.width')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.qty')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.opration')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.planning.fields.complate_date')); ?>
            ...
            <?php echo $__env->make('admin.productionPlanning.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <!-- Modal Cancel -->
        <?php echo $__env->make('admin.productionPlanning.orderData', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.productionPlanning.open', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.productionPlanning.chart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.productionPlanning.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- END Modal Cancel-->
    </div>
    ...
    <script>
        $(document).on('click', '#detPlanning', function() {
            ...
            var tableDt = $('#table_008').DataTable({
                "bServerSide": true,
                ajax: {
                    url: '<?php echo e(url('search/plnDet')); ?>',
                    type: "POST",
                    headers: {
        ...
        $(document).ready(function() {
            ...
            var table_planning = $('#planning').DataTable({
                "bServerSide": true,
                ajax: {
                    url: '<?php echo e(url("search/planning-report")); ?>',
                    type: "GET",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            var table_order = $('#order-summary').DataTable({
                "bServerSide": true,
                ajax: {
                    url: '<?php echo e(url('search/order-summary')); ?>',
                    type: "POST",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/productionPlanning/index.blade.php ENDPATH**/ ?>