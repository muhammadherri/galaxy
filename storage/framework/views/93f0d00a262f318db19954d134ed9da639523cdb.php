                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control calculate" value="<?php echo e(number_format($ar->amount_applied  - $ar->amount_applied_from )); ?>" name="amount_paid" id="paid" oninput="myFunction()" autocomplete="off">
                                <input type="hidden" class="form-control calculate" value="<?php echo e($ar->amount_applied - $ar->amount_applied_from); ?>" name="amount" id="payment" autocomplete="off">
                        ...
                        <div class="col-md-2 col-12">
                            <div class="mb-1">
                                ...
                                <select name="payment_currency_code" id="currency" class="form-control select2" required>
                                    ...
                                    <option value="<?php echo e($row->currency_code); ?>" <?php echo e($cust->invoice_currency_code == $row->currency_code ? 'selected' : ''); ?>> <?php echo e($row->currency_code); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" name="memo" value="<?php echo e($cust->trx_number); ?>" autocomplete="off">
                                <input type="hidden" class="form-control" name="invoice_id" value="<?php echo e($cust->trx_number); ?>" autocomplete="off">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/resources/views/admin/arReceivable/action.blade.php ENDPATH**/ ?>