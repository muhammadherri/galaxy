                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="mb-2">
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" id="datepicker-1" name="create_date" value="" class="form-control datepicker" autocomplete="off" required>
                                            </div>
                                            <div class="col-sm-2"></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/asset/create.blade.php ENDPATH**/ ?>