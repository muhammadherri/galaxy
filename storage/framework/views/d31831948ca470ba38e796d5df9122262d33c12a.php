                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <select name="cust" id="cust" class="form-control select2" required>
                                        ...
                                        <?php $__currentLoopData = $cust; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($row->cust_party_code); ?>"><?php echo e($row->party_name); ?>
...
</form><?php /**PATH /var/www/html/resources/views/admin/sales/filter.blade.php ENDPATH**/ ?>