    ...
    <div class="card">
        <div class="card-header  mt-1 mb-25">
            <h6 class="card-title">
                ...
                <a href="<?php echo e(route("admin.ap.index")); ?>" class="breadcrumbs__item">AP List </a>
                                            ...
                                            <table class="table table-fixed table-borderless">
                                                ...
                                                <tbody class="requisition_container">
                                                    ...
                                                    <tr class="tr_input" id="rowTab1_<?php echo e($key+1); ?>">
                                                        ...
                                                        <td width="15%">
                                                            <input type="text" name="quantity_invoiced[]" class="form-control recount_ap float-center text-end" value="<?php echo e($row->quantity_invoiced); ?>" id="qty_<?php echo e($key+1); ?>" autocomplete="off">
                                                        </td>
                                                        <td width="10%">
                                            ...
                                            <table class="table table-fixed table-borderless">
                                                ...
                                                <tbody class="journal_container">
                                                    ...
                                                    <tr class="tr_input">
                                                        ...
                                                        <td width="20%">
                                                            <label class="form-control text-end" id="price2_<?php echo e($key+1); ?>"><?php echo e(number_format($row->total_rec_tax_amount)); ?></label>
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td width="20%">
                                                            <label class="form-control text-end"><?php echo e(number_format($row->total_rec_tax_amount)); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/creditMemo/edit.blade.php ENDPATH**/ ?>