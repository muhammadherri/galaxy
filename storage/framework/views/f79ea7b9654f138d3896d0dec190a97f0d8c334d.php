                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-2">
                                    ...
                                    <input type="text" id="created_at" name="created_at" class="form-control" value="<?php echo e(date('d-M-Y H:i:s')); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/purchase/create.blade.php ENDPATH**/ ?>