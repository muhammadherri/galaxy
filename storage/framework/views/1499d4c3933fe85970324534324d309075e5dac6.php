                    ...
                    <table id="report-rcv" class=" table datatable-Order w-100">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <?php echo e(trans('cruds.rcv.fields.type')); ?>

                                </th>
                                <th>
                                    Order
                                </th>
                                <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans('cruds.autocreate.fields.vendor')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </th>
                                <th>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans('cruds.autocreate.fields.st')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </th>
                                <th>
                                ...
                                <th class="text-center">
                                    <?php echo e(trans('cruds.rcv.fields.aju')); ?>

                                </th>
                                <th>
                                    <?php echo e(trans('cruds.rcv.fields.curr')); ?>

                                </th>
                                <th class="text-end">
                                    <?php echo e(trans('cruds.rcv.fields.price')); ?>
                                ...
                                <th class="text-end">
                                    <?php echo e(trans('cruds.rcv.fields.conv')); ?>

                                </th>
                                <th class="text-end">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans('cruds.autocreate.fields.date')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </th>
                                <th style="text-align: center;">
                                    <?php echo e(trans('cruds.rcv.fields.grnno')); ?>

                                </th>
                                <th style="text-align: center;">
                                    <?php echo e(trans('cruds.rcv.fields.comments')); ?>

                                </th>
                                <th style="text-align: center;">
                                    <?php echo e(trans('cruds.rcv.fields.action')); ?>
    ...
    $(document).ready(function() {
        ...
        const table = $('#report-rcv').DataTable({
            ...
            , columnDefs: [{
                ...
                , {
                    render: function(data, type, row, index) {
                        content = `<a class="btn btn-sm " id="print-label" data-bs-toggle="modal" data-item="${row.item_code}" data-grn="${row.grn}" data-item_desc="${row.item_desc}" data-bs-target="#demoModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/rcv/index.blade.php ENDPATH**/ ?>