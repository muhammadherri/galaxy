...
<a href="" class="breadcrumbs__item"><?php echo e(trans('cruds.quality_management.material')); ?></a>
...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route('admin.qm-finsihGood.update',[$head->uniq_attribute_roll])); ?>" class="" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body mt-2">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="uniq_attribute_roll" class="form-control" readonly value="<?php echo e($head->uniq_attribute_roll); ?>" autocomplete="off" required>
                            </div>
                            ...
                            <div class="col-md-5">
                                <input type="text" id="datepicker-1" name="transaction_date" value="<?php echo e($head->transaction_date); ?>" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="planned_start_quantity" class="form-control" value="<?php echo e($head->itemmaster->item_code); ?> - <?php echo e($head->itemmaster->description); ?>" required>
                                <input type="hidden" name="inventory_item_id" class="form-control" value="<?php echo e($head->inventory_item_id); ?>" required>
                                <input type="hidden" name="reference" class="form-control" value="<?php echo e($head->reference); ?>" required>
                            </div>
                            <div class="col-md-1">
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="attribute_char" class="form-control datepicker" id="" value="<?php echo e($head->attribute_char); ?>" autocomplete="off" required>
                                ...
                                <div class="box-body scrollx" style="height: 300px;overflow: scroll;">
                                    <table class="table table-striped tableFixHead" id="">
                                        ...
                                        <tbody class="fg_quality_container">
                                            <?php $__currentLoopData = $qm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="tr_input">
                                                    <td class="td text-center" style="width:3%"><?php echo e($key+1); ?></td>
                                                    <td width="">
                                                        <input type="hidden" class="line_id" id="line_id_<?php echo e($key+1); ?>" name="attribute_num_quality[]" value="<?php echo e($key+1); ?>">
                                                        <input type="text" class="form-control td gsm text-center" value="<?php echo e($row->attribute_number_1); ?>" name="attribute_number_1[]" id="gsm_<?php echo e($key+1); ?>" placeholder="g/m2" autocomplete="off" required>
                                                        <input type="hidden" class="form-control text-center" value="<?php echo e($row->id); ?>" name="id[]" id="id_<?php echo e($key+1); ?>" autocomplete="off" required>
                                                    <td width="">
                                                        <input type="number" class="form-control td recount text-center" value="<?php echo e($row->attribute_number_2); ?>" id="moizture_<?php echo e($key+1); ?>" placeholder="%" name="attribute_number_2[]" required>
                                                    </td>
                                                    <td width="auto">
                                                        <input type="number" class="form-control td recount text-center" value="<?php echo e($row->attribute_number_3); ?>" id="thickness_<?php echo e($key+1); ?>" placeholder="mm" name="attribute_number_3[]" required>
                                                    </td>
                                                    <td width="auto">
                                                        <input type="number" id="bursting_<?php echo e($key+1); ?>" class="form-control harga text-center" value="<?php echo e($row->attribute_number_4); ?>" name="attribute_number_4[]" placeholder="Kgf/cm2" required>
                                                    </td>
                                                    <td width="auto" class="text-center"><input type="text" id="ringCrush_<?php echo e($key+1); ?>" value="<?php echo e($row->attribute_number_5); ?>" name="attribute_number_5[]" placeholder="Newton" class="form-control text-center" required></td>
                                                    <td width="auto">
                                                        <input type="text"  id="plyBonding_<?php echo e($key+1); ?>" class="form-control subtotal123 text-center" value="<?php echo e($row->attribute_number_6); ?>" name="attribute_number_6[]" placeholder="J/m2" name="subtotal[]">
                                                    </td>
                                                    <td width="auto" class="text-center"><input type="text" id="cobbTop_<?php echo e($key+1); ?>" name="attribute_number_7[]" value="<?php echo e($row->attribute_number_7); ?>" placeholder="g/m2"class="form-control text-center" required></td>
                                                    <td width="auto">
                                                        <input type="text"  id="cobbBottom_<?php echo e($key+1); ?>" class="form-control subtotal123 text-center" value="<?php echo e($row->attribute_number_8); ?>" name="attribute_number_8[]" placeholder="g/m2" name="subtotal[]">
                                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/finishGoodQuality/edit.blade.php ENDPATH**/ ?>