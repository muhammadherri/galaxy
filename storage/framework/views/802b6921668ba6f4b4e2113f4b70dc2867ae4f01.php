                        ...
                        <?php $subtotal_dr=0; $subtotal_cr=0; ?>
                         <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-end"><b><?php echo e(number_format($row->entered_dr - $row->entered_cr, 3)); ?></b></td>
                            </tr>
                            ...
                            <?php $__currentLoopData = $lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><?php echo e(number_format($line->entered_dr - $line->entered_cr, 3)); ?></td>
                                </tr>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/stdReports/glReport.blade.php ENDPATH**/ ?>