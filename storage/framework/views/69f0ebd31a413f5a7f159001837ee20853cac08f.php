...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route('admin.qm-material.store')); ?>" class="imgUploader" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h6 class="card-title mb-25 mt-1">
                            ...
                            <a href="<?php echo e(route('admin.qm-material.create')); ?>" class="breadcrumbs__item">
                                Create</a>
                        </h6>
                    </div>
                    <hr>
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.date')); ?></label>
                                        <input type="text" id="" name="" class="form-control" value="<?php echo e($rcv_detail->rcvheader->gl_date->format('d-M-y')); ?>" >
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.aju')); ?></label>
                                        <input type="text" id="" name="attribute_aju" class="form-control" value="<?php echo e($aju); ?>" >
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.supplier')); ?></label>
                                        <input type="text" id="" name="" class="form-control" value="<?php echo e($rcv_detail->rcvheader->vendor_id); ?> - <?php echo e($rcv_detail->rcvheader->vendor->vendor_name); ?>" >
                                    </div>
                                </div>

                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.item')); ?></label>
                                        <input type="text" id="" name="" class="form-control" value="<?php echo e($rcv_detail->itemmaster->item_code); ?> - <?php echo e($rcv_detail->item_description); ?>" >
                                        <input type="hidden" id="" name="inventory_item_id" class="form-control" value="<?php echo e($rcv_detail->item_id); ?> " >
                                        <input type="hidden" id="" name="item_type" class="form-control" value="<?php echo e($rcv_detail->itemmaster->type_code); ?> " >
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.qty')); ?></label>
                                        <input type="text" id="" name="quantity1" class="form-control" value="<?php echo e(number_format($qty->qty, 3,'.') ?? ''); ?>" >
                                        <input type="hidden" id="" name="quantity" class="form-control" value="<?php echo e($qty->qty); ?>" >
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade show active" id="nav-sales" role="tabpanel" aria-labelledby="nav-sales-tab">
                                <div class="box-body " style="height: 300px;">
                                    <div class="col-md-12 mt-2">
                                        <div class="row mb-2">
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.long')); ?></label>
                                                <input type="text" id="" name="attribute_long" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.short')); ?></label>
                                                <input type="text" id="" name="attribute_short" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.out_throw')); ?></label>
                                                <input type="text" id="" name="attribute_outtrhow" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.prohibitive')); ?></label>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-4">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.moisture')); ?></label>
                                                <input type="text" id="" name="attribute_moisture" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.grade')); ?></label>
                                                <input type="text" id="" name="attribute_grade" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.keterangan')); ?></label>
                            ...
                            <div class="tab-pane fade" id="nav-priceList" role="tabpanel" aria-labelledby="nav-priceList-tab">
                                <div class="box-body " style="height: 300px;">
                                    <div class="col-md-12 mt-2">
                                        <div class="row mb-2">
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.hasil1')); ?></label>
                                                <input type="text" id="" name="intattribute1" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.hasil2')); ?></label>
                                                <input type="text" id="" name="intattribute2" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.hasil3')); ?></label>
                                                <input type="text" id="" name="intattribute3" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.hasil4')); ?></label>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.total')); ?></label>
                                                <input type="text" id="" name="intattribute5" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.waktu')); ?></label>
                                                <input type="text" id="" name="date_time" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.free')); ?></label>
                                                <input type="text" id="" name="attribute_free" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.gsm')); ?></label>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.thick')); ?></label>
                                                <input type="text" id="" name="attribute_thick" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.bright')); ?></label>
                                                <input type="text" id="" name="attribute_bright" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.light')); ?></label>
                                                <input type="text" id="" name="attribute_light" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.ash')); ?></label>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.bst')); ?></label>
                                                <input type="text" id="" name="attribute_bst" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.rct')); ?></label>
                                                <input type="text" id="" name="attribute_rct" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.density')); ?></label>
                                                <input type="text" id="" name="attribute_density" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.strength')); ?></label>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-4">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.hydra')); ?></label>
                                                <input type="text" id="" name="attribute_hydra" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.tutup')); ?></label>
                                                <input type="text" id="" name="" class="form-control" value="" >
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for=""><?php echo e(trans('cruds.quality_management.fields.tgl_tutup')); ?></label>
                                                <input type="text" id="" name="" class="form-control" value="" >
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/materialQuality/create.blade.php ENDPATH**/ ?>