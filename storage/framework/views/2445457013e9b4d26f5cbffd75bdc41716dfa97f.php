...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route('admin.qm-finsihGood.store')); ?>" class="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="card-body mt-2">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="uniq_attribute_roll" class="form-control" readonly value="<?php echo e($roll); ?>" autocomplete="off" required>
                            </div>
                            ...
                            <div class="col-md-5">
                                <input type="text" id="datepicker-1" name="transaction_date" value="<?php echo e(date('d-M-Y')); ?>" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="planned_start_quantity" class="form-control" value="<?php echo e($serial->item->item_code); ?> - <?php echo e($serial->item->description); ?>" required>
                                <input type="hidden" name="inventory_item_id" class="form-control" value="<?php echo e($serial->inventory_item_id); ?>" required>
                                <input type="hidden" name="reference" class="form-control" value="<?php echo e($serial->serial_number); ?>" required>
                            </div>
                            <div class="col-md-1">
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="attribute_char" class="form-control datepicker" id="" value="<?php echo e($serial->pm->name ?? ""); ?>" autocomplete="off" required>
                                ...
                                <div class="box-body scrollx" style="height: 300px;overflow: scroll;">
                                    <table class="table table-striped tableFixHead" id="">
                                        ...
                                        <tbody class="fg_quality_container">
                                            <tr class="tr_input">
                                                <td class="td text-center" style="width:3%">1</td>
                                                <td width="">
                                                    <input type="hidden" class="line_id" id="line_id_1" name="attribute_num_quality[]" value="1">
                                                    <input type="text" class="form-control td gsm text-center" name="attribute_number_1[]" id="gsm_1" placeholder="g/m2" autocomplete="off" required>
                                                <td width="">
                                                    <input type="number" class="form-control td recount text-center" id="moizture_1" placeholder="%" name="attribute_number_2[]" required>
                                                </td>
                                                <td width="auto">
                                                    <input type="number" class="form-control td recount text-center" id="thickness_1" placeholder="mm" name="attribute_number_3[]" required>
                                                </td>
                                                <td width="auto">
                                                    <input type="number" id="bursting_1" class="form-control harga text-center" name="attribute_number_4[]" placeholder="Kgf/cm2" required>
                                                </td>
                                                <td width="auto" class="text-center"><input type="text" id="ringCrush_1" name="attribute_number_5[]" placeholder="Newton" class="form-control text-center" required></td>
                                                <td width="auto">
                                                    <input type="text"  id="plyBonding_1" class="form-control subtotal123 text-center" name="attribute_number_6[]" placeholder="J/m2" name="subtotal[]">
                                                </td>
                                                <td width="auto" class="text-center"><input type="text" id="cobbTop_1" name="attribute_number_7[]"  placeholder="g/m2"class="form-control text-center" required></td>
                                                <td width="auto">
                                                    <input type="text"  id="cobbBottom_1" class="form-control subtotal123 text-center" name="attribute_number_8[]" placeholder="g/m2" name="subtotal[]">
                                                </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/finishGoodQuality/create.blade.php ENDPATH**/ ?>