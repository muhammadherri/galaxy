...
<div class="card" >
    ...
    <br>
    <div class="card-body">
        <form id = "formship" action="<?php echo e(route("admin.opunit.update",$operation->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <input type="text" id="short_name" name="short_name" value="<?php echo e($operation->short_name); ?>" class="form-control" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-2">
                            <label class="form-label"for="segment1"><?php echo e(trans('cruds.OpUnit.fields.name')); ?></label>
                            <input type="text" id="name" name="name" class="form-control" value="<?php echo e($operation->name); ?>" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <input required id="capacity" name="capacity"type="text" value="<?php echo e($operation->capacity); ?>" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-2">
                        <div class="mb-2">
                            ...
                            <input type="text" id="range_capacity_min" name="range_capacity_min" value="<?php echo e($operation->range_capacity_min); ?>" class="form-control" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-2">
                            <label class="form-label" for="segment1"><?php echo e(trans('cruds.OpUnit.fields.range_capacity_max')); ?></label>
                            <input type="text" id="range_capacity_max" name="range_capacity_max" value="<?php echo e($operation->range_capacity_max); ?>" class="form-control" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-2">
                            ...
                            <input type="text" id="range_gsm_min" name="range_gsm_min" class="form-control" value="<?php echo e($operation->range_gsm_min); ?>" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-2">
                            ...
                            <input type="text" id="range_gsm_max" name="range_gsm_max" class="form-control" value="<?php echo e($operation->range_gsm_max); ?>" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <select name="machine_status" id="mechine_status" class="form-control select2"  required>
                                <?php if($operation->machine_status == 1): ?>
                                    <option selected value="1"> Ready </option>
                                    <option value="2"> Off </option>
                                    <option value="0"> Maintenance </option>
                                <?php elseif($operation->machine_status == 2): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/opunit/edit.blade.php ENDPATH**/ ?>