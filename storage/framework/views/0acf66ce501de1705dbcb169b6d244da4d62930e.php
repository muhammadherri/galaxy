                     ...
                     <thead>
                         <tr>
                             <th colspan="6" class="text-center">
                                  Journal Bank <br> Period<?php echo e($from->format('d M Y')); ?> - <?php echo e($to->format('d M Y')); ?>
                     ...
                     <tbody>
                        <?php $subtotal_dr=0; $subtotal_cr=0; ?>
                         <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($row->effective_date->format('Y-m-d')); ?></td>
                                <td><?php echo e($row->code_combination_id); ?> <?php echo e($row->coa->description); ?></td>
                                <td><?php echo e($row->gl->external_reference); ?></td>
                                <td><?php echo e($row->description); ?></td>
                                <td class="text-end"><?php echo e(number_format($row->entered_dr,2)); ?></td>
                                <td class="text-end"><?php echo e(number_format($row->entered_cr,2)); ?></td>
                            </tr>
                            <?php $subtotal_dr+=$row->entered_dr; $subtotal_cr +=$row->entered_cr ;?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/stdReports/bankReport.blade.php ENDPATH**/ ?>