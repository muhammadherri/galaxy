...
<form action="<?php echo e(route('admin.credit-note.store')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal" novalidate>
        ...
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" class="form-control" name="ar_id" value="<?php echo e($cust->customer_trx_id); ?>" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"  name='action' value="save" class="btn btn-sm btn-primary check">Create Credit Note</button>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /var/www/html/resources/views/admin/arReceivable/creditNote.blade.php ENDPATH**/ ?>