...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route("admin.bom.store")); ?>" novalidate method="POST" enctype="multipart/form-data" class="form-horizontal create_purchase">
                ...
                <div class="card">
                    <div class="card-header mt-1">
                        <h6 class="card-title">
                            ...
                            <a href="<?php echo e(route("admin.bom.create")); ?>" class="breadcrumbs__item">Create </a>
                        </h6>
                    </div>
                    <hr>
                    <div class="card-body mt-2">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-5">
                                <input type="text" id="datepicker-1" name="efectivity_date" value="<?php echo e(date('d-M-Y')); ?>" class="form-control" required>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/bom/create.blade.php ENDPATH**/ ?>